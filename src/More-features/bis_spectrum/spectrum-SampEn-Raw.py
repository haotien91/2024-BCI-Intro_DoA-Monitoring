...
for i in range(0, len(all_eeg_data), segment_length):
    ...
    if len(segment) == segment_length:
        ...
        features.append(np.concatenate(([sampen], raw_data)))
...
plt.savefig('./Results/Prediction-SampEn-Raw.png')
plt.show()
...
plt.savefig('./Results/Figures/confusion_matrix-SampEn-Raw.png')
plt.show()
