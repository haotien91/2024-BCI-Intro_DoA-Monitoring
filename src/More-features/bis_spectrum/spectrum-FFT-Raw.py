...
for i in range(0, len(all_eeg_data), segment_length):
    ...
    if len(segment) == segment_length:
        ...
        features.append(np.concatenate(([psd_mean, psd_std], raw_data)))
...
plt.savefig('./Results/Prediction-FFT-Raw.png')
plt.show()
...
plt.savefig('./Results/Figures/confusion_matrix-FFT-Raw.png')
plt.show()
