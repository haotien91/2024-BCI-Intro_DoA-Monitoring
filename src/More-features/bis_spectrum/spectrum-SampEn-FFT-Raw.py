...
with parallel_backend('threading', n_jobs=40):
    ...
    grid_search = GridSearchCV(estimator=rf, param_grid=param_grid, cv=5, n_jobs=40, scoring='neg_mean_squared_error')
...
plt.savefig('./Results/Prediction-SampEn-FFT-Raw.png')
plt.show()
...
plt.savefig('./Results/Figures/confusion_matrix-SampEn-FFT-Raw.png')
plt.show()
